...
class PayIrClient:
    ...
    def init_transaction(self, amount, redirect_url, factor_number=None, mobile=None, description=None):
        ...
        response = requests.post(API_URL_SEND, data=a)
        print(response)
        print('vvv')
...
# a.init_transaction(1323, 'http://google.com')
# a.verify_transaction(123)
...
class RequestView(View):
    def get(self, request):
        ...
        z = a.init_transaction(amount=567666, redirect_url='http://127.0.0.1:8000/accounts/verify/',
                               factor_number='123456789',
                               mobile='09123456789', description='test')
        print(z)


class VerifyView(View):
    def get(self, request, order_id):
        # a = PayIrClient('f4caa85f-2021-43b4-8282-26540eb116d6')
        # a.verify_transaction(123)
        print('verify')
